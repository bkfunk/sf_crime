...
"""
This file loads SFPD data on all incidents (available at http://apps.sfgov.org/datafiles/view.php?file=Police/sfpd_incident_all_csv.zip), and geocodes the locations to census tracts, using the FCC's Census Block API.
"""
